...
const CartItem = ({
  item: { id, title, text, img, color, price, cartQuantity },
}) => {
    ...
    <div className="  flex  items-center justify-between w-full px-5">
      ...
      <div className="grid items-center gap-5">
        ...
        <div className="grid items-center justify-center">
          <button
            type="button"
            className="bg-theme-cart rounded p-1 lg:p-0.5 grid items-center justify-items-center cursor-pointer active:scale-90"
