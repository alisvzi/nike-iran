...
const Hero = ({
  ...
  heroapi: { title, btntext, subtitle, img, sociallinks, videos },
}) => {
  return (
    <>
      <div className="relative h-auto w-auto flex flex-col">
        ...
        <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container">
          <div className="grid items-center justify-items-center mt-28 md:mt24">
            ...
            <h1 className="text-6xl lg:text-5xl mt-4 md:text-4xl sm:text-3xl xsm:text-2xl font-extrabold filter drop-shadow-sm text-slate-200">
              {subtitle}
            </h1>
            <button
              type="button"
          ...
          <div className="">
            <img
              src={img}
              alt="hero-img"
              className="w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] transitions-theme -rotate-[10deg] hover:rotate-0 cursor-pointer object-fill"
            />
          </div>
        </div>
      </div>
